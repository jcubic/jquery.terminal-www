VERSION=0.9.1
# wput -nv
#UPLOAD=wput -u $(1) ftp://jcubic:vampire666@ftp.jcubic.pl/terminal$(2)
UPLOAD=upload $(1) $(2)
...
upload: .upload/service.php .upload/notification.rss .upload/api_reference.php .upload/examples.php .upload/jquery.terminal-min.js .upload/jquery.terminal-src.js .upload/jquery.terminal-$(VERSION).min.js .upload/jquery.terminal-$(VERSION).js .upload/jquery.terminal.css .upload/style.css .upload/index.php .upload/unix_formatting.js
