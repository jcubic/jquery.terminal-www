...
upload: .upload/service.php .upload/notification.rss .upload/api_reference.php .upload/examples.php .upload/jquery.terminal-min.js .upload/jquery.terminal-src.js .upload/jquery.terminal-$(VERSION).min.js .upload/jquery.terminal-$(VERSION).js .upload/jquery.terminal-$(VERSION).css .upload/jquery.terminal.css .upload/style.css .upload/index.php .upload/unix_formatting.js
