...
<pre class="separator"><?php echo str_repeat("-", 196); ?></pre>
    ...
    <section>
      ...
      <article id="thanks">
        ...
        <ul>
          <li><a href="https://travis-ci.org/">Travis CI</a> &mdash; Continues Integraion service that allow to run tests for on each commit and Pull Request.</li>
        ...
        <p>Here are status of this services on master branch:</p>
        <ul class="badges">
          <li>
            <span>Travis:</span>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          ...
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.23.2/js/prism.js"
                 download target="_blank">prism.js</a> - formatter for syntax highligting (it require PrismJS library) [8,0KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.23.2/js/less.js"
...
&lt;script src="js/jquery.terminal-1.23.2.min.js"&gt;&lt;/script&gt;<br/>
...
&lt;link href="css/jquery.terminal-1.23.2.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>You can also grab the files using a CDN (Content Distribution Network):</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.23.2/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.23.2/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>or</p>
