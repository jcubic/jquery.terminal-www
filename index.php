...
<pre class="separator">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</pre>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.1/js/jquery.terminal-1.7.1.js" download target="_blank">jquery.terminal-1.7.1.js</a> - unminified version [292KB] [Gzip: 56KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.1/js/jquery.terminal-1.7.1.min.js" download target="_blank">jquery.terminal-1.7.1.min.js</a> - minified version [84KB] [Gzip: 28KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.1/js/unix_formatting.js" download target="_blank">unix_formatting.js</a> - ANSI escape codes and overtyping [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.1/css/jquery.terminal-1.7.1.css" download target="_blank">jquery.terminal-1.7.1.css</a> - stylesheet [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.1/css/jquery.terminal-1.7.1.min.css" download target="_blank">jquery.terminal-1.7.1.min.css</a> - minified stylesheet [8,0KB] [Gzip: 4,0KB]</li>
      ...
      <article>
        ...
        <pre class="wrapper"><code>&lt;script src="js/jquery.terminal-1.7.1.min.js"&gt;&lt;/script&gt;<br/>
&lt;script src="js/jquery.mousewheel-min.js"&gt;&lt;/script&gt;<br/>
&lt;link href="css/jquery.terminal-1.7.1.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>You can also grab the files using CDN:</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.7.1/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.7.1/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>or</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.7.1/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.7.1/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
      </article>
      <article>
