...
<pre class="separator"><?php echo str_repeat("-", 196); ?></pre>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/js/jquery.terminal-2.7.0.js"
                 download target="_blank">jquery.terminal-2.7.0.js</a> - unminified version [412KB] [Gzip: 80KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/js/jquery.terminal-2.7.0.min.js"
                 download target="_blank">jquery.terminal-2.7.0.min.js</a> - minified version [128KB] [Gzip: 44KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/js/unix_formatting.js"
                 download target="_blank">unix_formatting.js</a> - ANSI escape codes and overtyping [28KB] [Gzip: 8,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/js/prism.js"
                 download target="_blank">prism.js</a> - formatter for syntax highligting (it require PrismJS library) [8,0KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/js/less.js"
          ...
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/css/jquery.terminal-2.7.0.css"
                 download target="_blank">jquery.terminal-2.7.0.css</a> - stylesheet [24KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/2.7.0/css/jquery.terminal-2.7.0.min.css"
                 download target="_blank">jquery.terminal-2.7.0.min.css</a> - minified stylesheet [16KB] [Gzip: 4,0KB]</li>
...
&lt;script src="js/jquery.terminal-2.7.0.min.js"&gt;&lt;/script&gt;<br/>
...
&lt;link href="css/jquery.terminal-2.7.0.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>You can also grab the files using a CDN (Content Distribution Network):</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.7.0/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.7.0/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>or</p>
