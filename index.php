...
<pre class="separator">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</pre>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.10.1/js/jquery.terminal-1.10.1.js" download target="_blank">jquery.terminal-1.10.1.js</a> - unminified version [320KB] [Gzip: 60KB]</li>
