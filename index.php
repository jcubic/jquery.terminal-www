...
<pre class="separator">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</pre>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.0/js/jquery.terminal-1.7.0.js" download target="_blank">jquery.terminal-1.7.0.js</a> - unminified version [292KB] [Gzip: 56KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.0/js/jquery.terminal-1.7.0.min.js" download target="_blank">jquery.terminal-1.7.0.min.js</a> - minified version [84KB] [Gzip: 28KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.0/js/unix_formatting.js" download target="_blank">unix_formatting.js</a> - ANSI escape codes and overtyping [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.0/css/jquery.terminal-1.7.0.css" download target="_blank">jquery.terminal-1.7.0.css</a> - stylesheet [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.7.0/css/jquery.terminal-1.7.0.min.css" download target="_blank">jquery.terminal-1.7.0.min.css</a> - minified stylesheet [8,0KB] [Gzip: 4,0KB]</li>
      ...
      <article>
        ...
        <pre class="wrapper"><code>&lt;script src="js/jquery.terminal-1.7.0.min.js"&gt;&lt;/script&gt;<br/>
&lt;script src="js/jquery.mousewheel-min.js"&gt;&lt;/script&gt;<br/>
&lt;link href="css/jquery.terminal-1.7.0.min.css" rel="stylesheet"/&gt;</code></pre>
