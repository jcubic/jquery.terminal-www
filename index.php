...
<pre class="separator"><?php echo str_repeat("-", 196); ?></pre>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.22.2/js/jquery.terminal-1.22.2.js"
                 download target="_blank">jquery.terminal-1.22.2.js</a> - unminified version [320KB] [Gzip: 60KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.22.2/js/jquery.terminal-1.22.2.min.js"
                 download target="_blank">jquery.terminal-1.22.2.min.js</a> - minified version [92KB] [Gzip: 32KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.22.2/js/unix_formatting.js"
                 download target="_blank">unix_formatting.js</a> - ANSI escape codes and overtyping [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.22.2/css/jquery.terminal-1.22.2.css"
                 download target="_blank">jquery.terminal-1.22.2.css</a> - stylesheet [20KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/11.22.2/css/jquery.terminal-1.22.2.min.css"
                 download target="_blank">jquery.terminal-1.22.2.min.css</a> - minified stylesheet [12KB] [Gzip: 4,0KB]</li>
...
&lt;script src="js/jquery.terminal-1.22.2.min.js"&gt;&lt;/script&gt;<br/>
...
&lt;link href="css/jquery.terminal-1.22.2.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>You can also grab the files using a CDN (Content Distribution Network):</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.22.2/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.22.2/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>or</p>
