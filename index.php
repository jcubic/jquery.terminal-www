...
It can also be used as debugging tool.
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.15.0/js/jquery.terminal-1.11.4.js"
                 download target="_blank">jquery.terminal-1.15.0.js</a> - unminified version [320KB] [Gzip: 60KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.15.0/js/jquery.terminal-1.11.4.min.js"
                 download target="_blank">jquery.terminal-1.15.0.min.js</a> - minified version [92KB] [Gzip: 32KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.15.0/js/unix_formatting.js"
                 download target="_blank">unix_formatting.js</a> - ANSI escape codes and overtyping [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.15.0/css/jquery.terminal-1.11.4.css"
                 download target="_blank">jquery.terminal-1.15.0.css</a> - stylesheet [20KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/11.15.0/css/jquery.terminal-1.11.4.min.css"
                 download target="_blank">jquery.terminal-1.15.0.min.css</a> - minified stylesheet [12KB] [Gzip: 4,0KB]</li>
...
&lt;script src="js/jquery.terminal-1.15.0.min.js"&gt;&lt;/script&gt;<br/>
...
&lt;link href="css/jquery.terminal-1.15.0.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>You can also grab the files using a CDN (Content Distribution Network):</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.15.0/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.15.0/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>or</p>
