...
<pre class="separator">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</pre>
    ...
    $('#term_demo').terminal(function(command, term) {
      ...
      <article>
        ...
        <ul>
          <li><a href="js/jquery.terminal-0.11.0.js">jquery.terminal-0.11.0.js</a> - source [232KB]</li>
          <li><a href="js/jquery.terminal-0.11.0.min.js">jquery.terminal-0.11.0.min.js</a> - minified version [63KB]</li>
          <li><a href="js/unix_formatting.js">unix_formatting.js</a> - formatting for ANSI code and overtyping [14KB]</li>
          <li><a href="css/jquery.terminal-0.11.0.css">jquery.terminal-0.11.0.css</a> - stylesheet [6,1KB]</li>
          <li><a href="css/jquery.terminal-0.11.0.min.css">jquery.terminal-0.11.0.min.css</a> - stylesheet [4,4KB]</li>
...
npm install --save jquery.terminal
          ...
          <code class="wrapper">
&lt;script src="js/jquery.terminal-0.11.0.min.js"&gt;&lt;/script&gt;<br/>
&lt;script src="js/jquery.mousewheel-min.js"&gt;&lt;/script&gt;<br/>
&lt;link href="css/jquery.terminal-0.11.0.min.css" rel="stylesheet"/&gt;
          </code>
          <p>You can also grab the files using CDN:</p>
          <code class="wrapper">
&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/0.11.0/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/0.11.0/css/jquery.terminal.min.css" rel="stylesheet"/&gt;
          </code>
          <p>or</p>
          <code class="wrapper">
&lt;script&nbsp;src="https://cdn.jsdelivr.net/jquery.terminal/0.11.0/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdn.jsdelivr.net/jquery.terminal/0.11.0/jquery.terminal.min.css" rel="stylesheet"/&gt;
          </code>
      </article>
      <article>
