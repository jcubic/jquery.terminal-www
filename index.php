...
<pre class="separator">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</pre>
    ...
    $('#term_demo').terminal(function(command) {
      ...
      <article>
        ...
        <ul>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.12.1/js/jquery.terminal-1.12.1.js" download target="_blank">jquery.terminal-1.12.1.js</a> - unminified version [324KB] [Gzip: 64KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.12.1/js/jquery.terminal-1.12.1.min.js" download target="_blank">jquery.terminal-1.12.1.min.js</a> - minified version [92KB] [Gzip: 32KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.12.1/js/unix_formatting.js" download target="_blank">unix_formatting.js</a> - ANSI escape codes and overtyping [16KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.12.1/css/jquery.terminal-1.12.1.css" download target="_blank">jquery.terminal-1.12.1.css</a> - stylesheet [20KB] [Gzip: 4,0KB]</li>
          <li><a href="https://raw.githubusercontent.com/jcubic/jquery.terminal/1.12.1/css/jquery.terminal-1.12.1.min.css" download target="_blank">jquery.terminal-1.12.1.min.css</a> - minified stylesheet [12KB] [Gzip: 4,0KB]</li>
          ...
          <li>If you want to support wider characters, like Chinese or Japanese, you can use <a href="https://github.com/timoxley/wcwidth">wcwidth</a>. <strong>The library need to be included before jQuery Terminal.</strong></li>
        </ul>
      </article>
      <article>
...
&lt;script src="js/jquery.terminal-1.12.1.min.js"&gt;&lt;/script&gt;<br/>
...
&lt;link href="css/jquery.terminal-1.12.1.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>You can also grab the files using CDN:</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.12.1/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.12.1/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>or</p>
        <pre class="wrapper"><code>&lt;script&nbsp;src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.12.1/js/jquery.terminal.min.js"&gt;&lt;/script&gt;<br/>
&lt;link&nbsp;href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.12.1/css/jquery.terminal.min.css" rel="stylesheet"/&gt;</code></pre>
        <p>And if you want:</p>
        ...
        <p>If you want always the lastest version, you can grab the files from github using rawgit.com</p>
