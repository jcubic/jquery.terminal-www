...
<pre class="separator">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</pre>
    ...
    $('#term_demo').terminal(function(command, term) {
      ...
      <article>
        ...
        <ul>
          <li><a href="js/jquery.terminal-0.10.12.js">jquery.terminal-0.10.12.js</a> - source [223KB]</li>
          <li><a href="js/jquery.terminal-0.10.12.min.js">jquery.terminal-0.10.12.min.js</a> - minified version [61KB]</li>
          <li><a href="js/unix_formatting.js">unix_formatting.js</a> - formatting for ANSI code and overtyping [14KB]</li>
          <li><a href="css/jquery.terminal-0.10.12.css">jquery.terminal-0.10.12.css</a> - stylesheet [6,1KB]</li>
          <li><a href="css/jquery.terminal-0.10.12.min.css">jquery.terminal-0.10.12.min.css</a> - stylesheet [4,4KB]</li>
...
npm install --save jquery.terminal
          ...
          <code class="wrapper">
&lt;script src="js/jquery.terminal-0.10.12.min.js"&gt;&lt;/script&gt;<br/>
&lt;script src="js/jquery.mousewheel-min.js"&gt;&lt;/script&gt;<br/>
&lt;link href="css/jquery.terminal-0.10.12.min.css" rel="stylesheet"/&gt;
          </code>
