...
function(user, password, callback) {
    if (user == 'demo' && password == 'secret') {
        ...
        callback(null);
          ...
          <li id="mobileDelete"><strong>mobileDelete [bool]</strong> &mbdash; default to true if used on mobile device false on desktop (if set to true it will delete word when you hold key that should delete character e.g. delete or backspace key).</li>
          <li id="autocompleteMenu"><strong>autocompleteMenu [bool]</strong> &bdash; default false, if set to true it will create menu for list of completion that you can click to complete the word, it require including of autocomplete_menu.js file.</li>
