...
console.log(str.search(re));
      ...
      <article id="security">
        ...
        <p>The other issue you may have (reflected XSS) if you enable <a href="#execHash">execHash</a> option and have any of the above options enabled and you echo stuff to users but don't save in DB.</p>
      </article>
      <article id="3rd">
