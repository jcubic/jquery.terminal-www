...
history.pushState(save_state.length-1, null, '&lt;NEW URL&gt;');</pre>
      ...
      <article id="different_look">
        ...
        <ul>
          ...
          <li><a href="https://github.com/jcubic/hacking.cafe">Hacking Cafe</a> &mdash; a successor to Fake Linux Terminal.</li>
        ...
        <ul>
          ...
          <li id="home_pages">Home Pages (Custom portfolio terminal websites)
            <ul>
              ...
              <li><a href="https://jakub.jankiewicz.org/">jakub.jankiewicz.org</a> &mdash; personal page of jQuery Terminal author (terminal portfolio + chat).</li>
              <li><a href="https://nathan-wigley.github.io/">Nathan Wigley</a> &mdash; terminal porfolio with bash like commands</li>
            </ul>
          </li>
          <li id="unusual">Unusual use of terminal
            <ul>
              ...
              <li><a href="https://hacking.cafe/">hacking.cafe</a> &mdash; terminal hackers playground.</li>
            </ul>
          </li>
